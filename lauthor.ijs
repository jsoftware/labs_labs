...
minwh 426 150;cc listbox listbox;
groupboxend;
bin zv;
cc ok button;cn "OK";
...
pc torder;
cc type static;
minwh 270 208;cc list listbox multiplesel;
...
minwh 462 100;cc comments editm;
bin hs;
...
cc ruler static;
minwh 664 200;cc text editm;
minwh 664 290;cc code editm;
bin z;
pas 0 0;pcenter;
rem form end;
)
